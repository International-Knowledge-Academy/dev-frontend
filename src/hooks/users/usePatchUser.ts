...
interface UsePatchUserReturn {
  patchUser: (id: string | number, payload: UpdateUserPayload) => Promise<User | void>;
  loading: boolean;
  error: string | null;
...
const usePatchUser = (): UsePatchUserReturn => {
  ...
  return { patchUser, loading, error, fieldErrors, reset };
};
