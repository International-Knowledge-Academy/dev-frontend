...
const CampsPage = () => {
  ...
  const { camps, count, loading, error, params, setParams, refetch } = useCamps();
      ...
      <PageHeader
        ...
        actions={
          <Button
            ...
            text="Add Club"
            icon={<Plus size={15} />}
            onClick={() => navigate("/account-manager/clubs/create")}
          />
        }
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-slate-50">
                    {camps.map((camp) => (
                      <tr
                        key={camp.uid}
                        onClick={() => navigate(`/account-manager/clubs/${camp.uid}`)}
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5" onClick={(e) => e.stopPropagation()}>
                          <div className="flex items-center gap-1">
                            <button
                              onClick={() => navigate(`/account-manager/clubs/${camp.uid}/edit`)}
