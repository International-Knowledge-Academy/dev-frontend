...
const levelBadge: Record<string, string> = {
  beginner:     "bg-emerald-50 text-emerald-600 border-emerald-600",
  intermediate: "bg-amber-50 text-amber-600 border-amber-600",
  advanced:     "bg-purple-50 text-purple-600 border-purple-600",
};

const modeBadge: Record<string, string> = {
  online:  "bg-cyan-50 text-cyan-600 border-cyan-600",
  offline: "bg-orange-50 text-orange-600 border-orange-600",
  hybrid:  "bg-indigo-50 text-indigo-600 border-indigo-600",
};
