...
const CourseCreatePage = () => {
  ...
  const { createCourse, loading, error, fieldErrors } = useCreateCourse();
  ...
  return (
    <div className="bg-white dark:bg-navy-800 rounded-2xl border border-gray-100 dark:border-navy-700 shadow-sm">
      <div className="px-6 py-4 border-b border-gray-100 dark:border-navy-700">
        <h1 className="text-base font-bold text-navy-800 dark:text-white">Create Course</h1>
        <p className="text-xs text-gray-400 mt-0.5">Fill in the details to add a new training course</p>
      </div>
