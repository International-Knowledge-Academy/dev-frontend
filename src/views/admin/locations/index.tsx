...
import {
  MdAddLocation, MdRefresh, MdPlace, MdLocationCity, MdPublic,
  MdToggleOn, MdSettings, MdSchool, MdEdit, MdDelete, MdWarning,
      ...
      <div className="bg-white rounded-2xl border border-slate-100 max-w-5xl mx-auto">
        ...
        <div className="px-4 sm:px-6 pt-4 pb-1 space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Desktop: all controls inline in one row */}
            <div className="hidden sm:flex items-center gap-2 shrink-0">
              ...
              />
              <span className="text-sm text-slate-400 whitespace-nowrap">{count} locations</span>
            </div>
          </div>
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {locations.map((location) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-3.5 text-slate-500">{location.country}</td>
                        <td className="px-5 py-3.5">
