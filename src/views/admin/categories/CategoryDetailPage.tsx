      ...
      <div className="bg-white dark:bg-navy-800 rounded-2xl border border-gray-100 dark:border-navy-700 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-gray-100 dark:border-navy-700 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-base font-bold text-navy-800 dark:text-white">{category.name}</h1>
            <p className="text-xs text-gray-400 mt-0.5">{category.uid}</p>
          </div>
        </div>
        ...
        <div className="px-6 py-5">
          ...
          <p className="text-sm font-medium text-navy-800 dark:text-white">{category.name}</p>
        </div>
