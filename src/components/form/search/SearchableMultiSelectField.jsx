  ...
  return (
    <div className="mb-4 relative" ref={containerRef}>
      ...
      <div
        ...
        className={`mt-2 flex min-h-12 w-full items-center justify-between rounded-md border bg-white p-3 text-sm transition-colors focus:ring-1 focus:ring-blue-500 ${
      ...
      {isOpen && (
        ...
        >
          ...
          <input
            ...
            className={`mb-2 flex h-10 w-full rounded-md border p-2 text-sm focus:ring-1 focus:ring-blue-500 ${
              getNestedValue(errors, field)
                ? "border-red-500"
                : "border-default"
            }`}
