          ...
          <div className="flex items-center justify-between">
            ...
            {!uploading && (
              <button
                type="button"
                onClick={onRemove}
                className="flex items-center justify-center gap-2 rounded-md lg:rounded-lg border border-red-600 px-4 py-2 text-sm font-medium text-red-600 transition hover:border-red-700 hover:bg-red-50 disabled:opacity-50"
              >
