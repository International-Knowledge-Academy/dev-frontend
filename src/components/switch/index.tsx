...
const Switch = (props) => {
  ...
  return (
    <input
      type="checkbox"
      className={`relative h-5 w-10 appearance-none rounded-3xl bg-[#e0e5f2] outline-none transition duration-[0.5s] 
      before:absolute before:top-[50%] before:h-4 before:w-4 before:translate-x-[2px] before:translate-y-[-50%] before:rounded-3xl
