    ...
    <nav className="sticky top-4 z-40 flex flex-row flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl">
      ...
      <div className="relative mt-[3px] flex h-[61px] w-[355px] flex-grow items-center justify-around gap-2 rounded-full bg-white px-2 py-2 shadow-xl shadow-shadow-500 md:w-[365px] md:flex-grow-0 md:gap-1 xl:w-[365px] xl:gap-2">
        ...
        <Dropdown
          ...
          children={
            <div className="flex w-[360px] flex-col gap-3 rounded-3xl bg-white p-4 shadow-xl shadow-shadow-500 sm:w-[460px]">
        ...
        <Dropdown
          ...
          children={
            <div className="flex w-[350px] flex-col gap-2 rounded-3xl bg-white p-4 shadow-xl shadow-shadow-500">
              <div
                style={{
        ...
        <Dropdown
          ...
          children={
            <div className="flex w-56 flex-col justify-start rounded-3xl bg-white bg-cover bg-no-repeat shadow-xl shadow-shadow-500">
              <div className="p-4">
